...
<div id="app">
    <nav class="tabs">
        ...
        <button type="button" data-paso="2">Mi Cita</button>
    ...
    <div class="paginacion">
        <button id="anterior" class="boton">&laquo; Back</button>

        <button id="siguiente" class="boton">Next &raquo;</button>
    </div>
</div>
